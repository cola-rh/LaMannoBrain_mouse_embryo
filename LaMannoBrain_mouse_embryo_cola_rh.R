setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_mouse_embryo")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_mouse_embryo/LaMannoBrain_mouse_embryo_data.rds')
